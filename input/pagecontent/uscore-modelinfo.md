...
|---|---|
|[AllergyIntolerance Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-allergyintolerance.html)|code|
|[BMI Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-bmi.html)|code|
|[Blood Pressure Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-blood-pressure.html)|code|
|[Body Height Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-body-height.html)|code|
|[Body Temperature Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-body-temperature.html)|code|
|[Body Weight Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-body-weight.html)|code|
|[CarePlan Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-careplan.html)|category|
|[CareTeam Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-careteam.html)|category|
|[Condition Encounter Diagnosis Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-condition-encounter-diagnosis.html)|code|
|[Condition Problems and Health Concerns Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-condition-problems-health-concerns.html)|code|
...
|[Implantable Device Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-implantable-device.html)|type|
|[Laboratory Result Observation Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-observation-lab.html)|code|
|[Location Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-location.html)|type|
|[Medication Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-medication.html)|code|
|[MedicationDispense Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-medicationdispense.html)|medication|
|[MedicationRequest Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-medicationrequest.html)|medication|
|[Observation Clinical Result Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-observation-clinical-result.html)|code|
|[Observation Occupation Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-observation-occupation.html)|code|
|[Observation Pregnancy Intent Profile]({{site.data.fhir.ver.uscore6}}/StructureDefinition-us-core-observation-pregnancyintent.html)|code|
